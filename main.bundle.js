...
var routes = [
    { path: 'features', component: __WEBPACK_IMPORTED_MODULE_5__features_features_component__["a" /* FeaturesComponent */] },
    { path: 'pricing', component: __WEBPACK_IMPORTED_MODULE_6__pricing_pricing_component__["a" /* PricingComponent */] },
    { path: 'posts', component: __WEBPACK_IMPORTED_MODULE_8__posts_posts_component__["a" /* PostsComponent */] },
    { path: 'posts/:id', component: __WEBPACK_IMPORTED_MODULE_9__post_post_component__["a" /* PostComponent */] }
];
